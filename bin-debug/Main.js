...
var Main = (function (_super) {
    ...
    Main.prototype.onConfigComplete = function (event) {
        ...
        var scale = this.stage.stageWidth / this.stage.stageHeight;
        if (scale < 1.34 || scale > 1.78) {
            this.stage.scaleMode = egret.StageScaleMode.FIXED_WIDTH; //SHOW_ALL
            if (scale < 1.5)
                this.stage.setContentSize(640, 960);
        }
        else {
            this.stage.scaleMode = egret.StageScaleMode.FIXED_WIDTH; //fixedWidth //NO_BORDER;
        }
    };
    /**
     * 主题文件加载完成,开始预加载
